var mapapp =(function(){
	...
	function getBAGpandFromPcHn(pc, hn){
		...
		var url = "http://almere.pilod.nl/sparql?default-graph-uri=&query=SELECT+DISTINCT+%3Fstraat+%3Fhuisnummer+%3Fpc+%3Fplaats+%3Fgeom%0D%0AWHERE+%7B%0D%0A%3Fnummer+a+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23Nummeraanduiding%3E+.%0D%0A%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23postcode%3E+%3Fpc+.%0D%0A%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisnummer%3E+%3Fhuisnummer+.%0D%0A%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeOpenbareRuimte%3E+%3For+.%0D%0AOPTIONAL+%7B%3For+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23naamOpenbareRuimte%3E+%3Fstraat+.%7D%0D%0AOPTIONAL+%7B%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeWoonplaats%3E+%3Fplaats+.%7D%0D%0A%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23hoofdadres%3E+%3Fnummer+.+%0D%0A%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23onderdeelVan%3E+%3Fpand+.%0D%0A%3Fpand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23hasGeometry%3E+%3Fgeompand+.%0D%0A%3Fgeompand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23asWKT%3E+%3Fgeom+.%0D%0AFILTER+regex%28%3Fpc%2C+%22" + pc + "%22%2C+%22i%22%29%0D%0AFILTER+%28xsd%3Ainteger%28%3Fhuisnummer%29+%3D+xsd%3Ainteger%28%22" + hn + "%22%29%29+.%0D%0A%7D+LIMIT+10&should-sponge=&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on"
		getBAGpandFromUrl(url);
	}

	function getBAGpandFromPcHnHl(pc, hn, hl){
		//zoek het adres met pc en hn op via SPARQL en voeg alle gevonden records toe aan de kaart
		var url = "http://almere.pilod.nl/sparql?default-graph-uri=&query=SELECT+DISTINCT+%3Fstraat+%3Fhuisnummer+%3Fhuisletter+%3Fpc+%3Fplaats+%3Fgeom+WHERE+%7B%3Fnummer+a+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23Nummeraanduiding%3E+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23postcode%3E+%3Fpc+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisnummer%3E+%3Fhuisnummer+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisletter%3E+%3Fhuisletter+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeOpenbareRuimte%3E+%3For+.+OPTIONAL+%7B%3For+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23naamOpenbareRuimte%3E+%3Fstraat+%7D+.+OPTIONAL+%7B%3For+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeWoonplaats%3E+%3Fplaats+%7D+.+%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23hoofdadres%3E+%3Fnummer+.+%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23onderdeelVan%3E+%3Fpand+.+%3Fpand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23hasGeometry%3E+%3Fgeompand+.+%3Fgeompand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23asWKT%3E+%3Fgeom+.+FILTER+regex%28%3Fpc%2C+%22" + pc + "%22%2C+%22i%22%29+.+FILTER+%28xsd%3Ainteger%28%3Fhuisnummer%29+%3D+xsd%3Ainteger%28%22" + hn + "%22%29%29+.+FILTER+regex%28%3Fhuisletter%2C+%22" + hl + "%22%2C+%22i%22%29%7D+LIMIT+10&should-sponge=&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on"
		getBAGpandFromUrl(url);
	}

	function getBAGpandFromPcHnHlToev(pc, hn, hl, toev){
		//zoek het adres met pc en hn op via SPARQL en voeg alle gevonden records toe aan de kaart
		var url = "http://almere.pilod.nl/sparql?default-graph-uri=&query=SELECT+DISTINCT+%3Fstraat+%3Fhuisnummer+%3Fhuisletter+%3Ftoevoeging+%3Fpc+%3Fplaats+%3Fgeom+WHERE+%7B%3Fnummer+a+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23Nummeraanduiding%3E+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23postcode%3E+%3Fpc+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisnummer%3E+%3Fhuisnummer+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisletter%3E+%3Fhuisletter+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisnummertoevoeging%3E+%3Ftoevoeging+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeOpenbareRuimte%3E+%3For+.+OPTIONAL+%7B%3For+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23naamOpenbareRuimte%3E+%3Fstraat+%7D.+OPTIONAL+%7B%3For+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeWoonplaats%3E+%3Fplaats+%7D+.+%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23hoofdadres%3E+%3Fnummer+.+%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23onderdeelVan%3E+%3Fpand+.+%3Fpand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23hasGeometry%3E+%3Fgeompand+.+%3Fgeompand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23asWKT%3E+%3Fgeom+.+FILTER+regex%28%3Fpc%2C%22" + pc + "%22%2C+%22i%22%29+.+FILTER+%28xsd%3Ainteger%28%3Fhuisnummer%29+%3D+xsd%3Ainteger%28%22" + hn + "%22%29%29+.+FILTER+regex%28%3Fhuisletter%2C%22" + hl + "%22%2C+%22i%22%29+.+FILTER+regex%28%3Ftoevoeging%2C%22" + toev + "%22%2C+%22i%22%29%7D+LIMIT+10&should-sponge=&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on"
		getBAGpandFromUrl(url);
	}

	function getBAGpandFromPcHnToev(pc, hn, toev){
		//zoek het adres met pc en hn op via SPARQL en voeg alle gevonden records toe aan de kaart
		var url = "http://almere.pilod.nl/sparql?default-graph-uri=&query=SELECT+DISTINCT+%3Fstraat+%3Fhuisnummer+%3Ftoevoeging+%3Fpc+%3Fplaats+%3Fgeom+WHERE+%7B%3Fnummer+a+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23Nummeraanduiding%3E+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23postcode%3E+%3Fpc+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisnummer%3E+%3Fhuisnummer+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23huisnummertoevoeging%3E+%3Ftoevoeging+.+%3Fnummer+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeOpenbareRuimte%3E+%3For+.+OPTIONAL+%7B%3For+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23naamOpenbareRuimte%3E+%3Fstraat+%7D+.+OPTIONAL+%7B%3For+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23gerelateerdeWoonplaats%3E+%3Fplaats+%7D+.+%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23hoofdadres%3E+%3Fnummer+.+%3Fvo+%3Chttp%3A%2F%2Fbag.kadaster.nl%2Fdef%23onderdeelVan%3E+%3Fpand+.+%3Fpand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23hasGeometry%3E+%3Fgeompand+.+%3Fgeompand+%3Chttp%3A%2F%2Fwww.opengis.net%2Font%2Fgeosparql%23asWKT%3E+%3Fgeom+.+FILTER+regex%28%3Fpc%2C%22" + pc + "%22%2C+%22i%22%29+.+FILTER+%28xsd%3Ainteger%28%3Fhuisnummer%29+%3D+xsd%3Ainteger%28%22" + hn + "%22%29%29+.+FILTER+regex%28%3Ftoevoeging%2C%22" + toev + "%22%2C+%22i%22%29%7D+LIMIT+10&should-sponge=&format=application%2Fsparql-results%2Bjson&timeout=0&debug=on"
		getBAGpandFromUrl(url);
	}
